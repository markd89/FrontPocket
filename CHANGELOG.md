...
- Alternatively, you can configure them to be spoken by having a line in the frontpocket.ini under [AllowedEmojis] such as ❤️ = love. See the model frontpocket.ini for examples.
